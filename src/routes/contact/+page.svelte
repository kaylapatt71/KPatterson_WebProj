...
<link rel="stylesheet" href="css\contact.css" /> <!-- Linking the contact CSS-->

<div class="container">
  <title>Contact Us | The Rolling Pin</title>
  <h3>Contact Form</h3>
  {#if form?.success} <!-- Display a success message if the form submission was successful -->
  ...
  <!-- Render a form with a POST method -->
    ...
    >
      <label for="first_name">First Name</label> <!-- Label for the 'first_name' input -->
      ...
      <label for="last_name">Last Name</label> <!-- Label for the 'last_name' input -->
      ...
      <label for="message">Message</label><br /> <!-- Label for the 'message' input -->
